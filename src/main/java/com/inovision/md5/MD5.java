...
public class MD5 {
	...
	*/
	...
	public String encrypt(String sMessage)
	{
		byte out[] = new byte[16];
		if(sMessage != null)
		{
			this.update(sMessage.getBytes(), sMessage.length());
			this.md5final(out);
	...
	public static void main(String args[]) {
		...
		try {
			System.out.print("Enter the string to MD5 encrypt: ");
...
//		md.md5final(out);
		...
		System.out.println("MD5 hash : " + md.encrypt(str));
	}
